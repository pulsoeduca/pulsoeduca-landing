    ...
    <section id="contato" className="py-28 bg-cream">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <form
          ...
          onSubmit={(e) => {
            ...
            const msg =
              ...
              `*E-mail:* ${email}\n\n` +
              `*Contexto:*\n${contexto}`;
            const url = `https://wa.me/5511941768637?text=${encodeURIComponent(msg)}`;
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm font-semibold text-ink">
          <a href="https://wa.me/5511941768637" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:text-primary transition-colors">
